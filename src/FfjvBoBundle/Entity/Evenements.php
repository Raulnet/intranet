 ...
 */
    ...
    public static $listType = [
        "entity.evenements.Type.other"   => self::TYPE_OTHER,
        "entity.evenements.Type.lounge"   => self::TYPE_LOUNGE,
        "entity.evenements.Type.tournement"   => self::TYPE_TOURNAMENT
    ];
     ...
     */
    private $type= self::STATUS_VISIBILITY_DRAFT;
