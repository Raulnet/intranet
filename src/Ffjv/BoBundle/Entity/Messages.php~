 ...
 * @ORM\Entity(repositoryClass="Ffjv\BoBundle\Repository\MessagesRepository")
 */
class Messages
{
    ...
    /**
     * @var \Ffjv\BoBundle\Entity\Ligues
     *
     * @ORM\ManyToOne(targetEntity="Ffjv\BoBundle\Entity\Ligues")
     * @ORM\JoinColumns({
     ...
     * @return Messages
     */
    public function setLigue(\Ffjv\BoBundle\Entity\Ligues $ligue = null)
    {
        $this->ligue = $ligue;
     ...
     * Get ligue
     *
     * @return \Ffjv\BoBundle\Entity\Ligues
     */
     ...
     * Set authorUser
     *
     * @param \Ffjv\BoBundle\Entity\User $authorUser
     *
     * @return Messages
     */
    public function setAuthorUser(\Ffjv\BoBundle\Entity\User $authorUser = null)
    {
