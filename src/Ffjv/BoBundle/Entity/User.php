 ...
 * @ORM\Entity(repositoryClass="Ffjv\BoBundle\Repository\UserRepository")
...
class User implements UserInterface
{
    ...
    /**
     * @var \Ffjv\BoBundle\Entity\LicencesUsers
     *
     * @ORM\ManyToOne(targetEntity="Ffjv\BoBundle\Entity\LicencesUsers")
     * @ORM\JoinColumns({
     ...
     *
     * @ORM\OneToMany(targetEntity="Ffjv\BoBundle\Entity\Clubs", mappedBy="user")
     */
    private $clubs;
     ...
     * @return User
     */
    public function addClub(\Ffjv\BoBundle\Entity\Clubs $club)
    {
        $this->clubs[] = $club;
     ...
     * @param \Ffjv\BoBundle\Entity\Clubs $club
     */
    public function removeClub(\Ffjv\BoBundle\Entity\Clubs $club)
    {
