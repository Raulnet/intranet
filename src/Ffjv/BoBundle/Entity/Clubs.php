 ...
 * @ORM\Entity(repositoryClass="Ffjv\BoBundle\Repository\ClubsRepository")
...
class Clubs
{
    ...
    /**
     * @var \Ffjv\BoBundle\Entity\LicencesClubs
     *
     * @ORM\ManyToOne(targetEntity="Ffjv\BoBundle\Entity\LicencesClubs")
     * @ORM\JoinColumns({
     ...
     *
     * @ORM\ManyToMany(targetEntity="Ffjv\BoBundle\Entity\Ligues", inversedBy="clubs")
     ...
     *
     * @ORM\OneToMany(targetEntity="Ffjv\BoBundle\Entity\Teams", mappedBy="club", cascade={"persist", "remove"})
     */
    private $teams;
     ...
     *
     * @ORM\OneToMany(targetEntity="Ffjv\BoBundle\Entity\Messages", mappedBy="club")
     */
    private $messages;
     ...
     *
     * @ORM\OneToMany(targetEntity="Ffjv\BoBundle\Entity\UserHasClubs", mappedBy="club", cascade={"persist", "remove"})
     */
     ...
     * Set licence
     *
     * @param \Ffjv\BoBundle\Entity\LicencesClubs $licence
     *
     * @return Clubs
     */
    public function setLicence(\Ffjv\BoBundle\Entity\LicencesClubs $licence = null)
    {
     ...
     * Get licence
     *
     * @return \Ffjv\BoBundle\Entity\LicencesClubs
     */
     ...
     * Add ligue
     *
     * @param \Ffjv\BoBundle\Entity\Ligues $ligue
     *
     * @return Clubs
     */
    public function addLigue(\Ffjv\BoBundle\Entity\Ligues $ligue)
    {
        $this->ligues[] = $ligue;
     ...
     * @param \Ffjv\BoBundle\Entity\Ligues $ligue
     */
    public function removeLigue(\Ffjv\BoBundle\Entity\Ligues $ligue)
    {
     ...
     * @return Clubs
     */
    public function addTeam(\Ffjv\BoBundle\Entity\Teams $team)
    {
        $this->teams[] = $team;
     ...
     * @param \Ffjv\BoBundle\Entity\Teams $team
     */
    public function removeTeam(\Ffjv\BoBundle\Entity\Teams $team)
    {
     ...
     * Add message
     *
     * @param \Ffjv\BoBundle\Entity\Messages $message
     *
     * @return Clubs
     */
    public function addMessage(\Ffjv\BoBundle\Entity\Messages $message)
    {
     ...
     * @param \Ffjv\BoBundle\Entity\Messages $message
     */
    public function removeMessage(\Ffjv\BoBundle\Entity\Messages $message)
    {
     ...
     * Add member
     *
     * @param \Ffjv\BoBundle\Entity\UserHasClubs $member
     *
     * @return Clubs
     */
    public function addMember(\Ffjv\BoBundle\Entity\UserHasClubs $member)
    {
        $this->members[] = $member;
     ...
     * @param \Ffjv\BoBundle\Entity\UserHasClubs $member
     */
    public function removeMember(\Ffjv\BoBundle\Entity\UserHasClubs $member)
    {
